...
/**
 * __useGetUsersByUuidQuery__
 *
 * To run a query within a React component, call `useGetUsersByUuidQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetUsersByUuidQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetUsersByUuidQuery({
 *   variables: {
 *      uuid: // value for 'uuid'
 *   },
 * });
 */
export function useGetUsersByUuidQuery(baseOptions: Apollo.QueryHookOptions<GetUsersByUuidQuery, GetUsersByUuidQueryVariables> & ({ variables: GetUsersByUuidQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetUsersByUuidQuery, GetUsersByUuidQueryVariables>(GetUsersByUuidDocument, options);
      }
export function useGetUsersByUuidLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetUsersByUuidQuery, GetUsersByUuidQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetUsersByUuidQuery, GetUsersByUuidQueryVariables>(GetUsersByUuidDocument, options);
        }
export function useGetUsersByUuidSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<GetUsersByUuidQuery, GetUsersByUuidQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetUsersByUuidQuery, GetUsersByUuidQueryVariables>(GetUsersByUuidDocument, options);
        }
export type GetUsersByUuidQueryHookResult = ReturnType<typeof useGetUsersByUuidQuery>;
export type GetUsersByUuidLazyQueryHookResult = ReturnType<typeof useGetUsersByUuidLazyQuery>;
export type GetUsersByUuidSuspenseQueryHookResult = ReturnType<typeof useGetUsersByUuidSuspenseQuery>;
export type GetUsersByUuidQueryResult = Apollo.QueryResult<GetUsersByUuidQuery, GetUsersByUuidQueryVariables>;