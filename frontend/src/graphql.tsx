...
export type GetUserByUsernameQuery = { __typename?: 'query_root', user: Array<{ __typename?: 'user', uuid: any, username: string }> };
...
export type UpdateUserPasswordMutation = { __typename?: 'mutation_root', update_user?: { __typename?: 'user_mutation_response', affected_rows: number, returning: Array<{ __typename?: 'user', uuid: any, username: string }> } | null };
...
export function useGetUserByUsernameSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<GetUserByUsernameQuery, GetUserByUsernameQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
...
export const UpdateUserPasswordDocument = gql`
    mutation updateUserPassword($uuid: uuid!, $newPasswordHash: String!) {
  update_user(where: {uuid: {_eq: $uuid}}, _set: {password: $newPasswordHash}) {
    affected_rows
    returning {
      uuid
      username
 ...
 *   variables: {
 *      uuid: // value for 'uuid'
 *      newPasswordHash: // value for 'newPasswordHash'
 *   },
 * });
 */
